...
declare module '$env/static/private' {
	export const VITE_BOT_PHONE: string;
	...
	export const npm_package_dependencies__tiptap_extension_placeholder: string;
	export const npm_package_dependencies__tiptap_extension_underline: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__tiptap_extension_placeholder: string;
		npm_package_dependencies__tiptap_extension_underline: string;
